...
normal = 'training/normal/normal_{}.tif'
tumor = 'training/tumor/tumor_{}.tif'
normal_paths = [base_url + normal.format(str(i).zfill(3)) for i in range(1, min(160,n_normal))]
tumor_paths = [base_url + tumor.format(str(i).zfill(3)) for i in range(1, min(111,n_tumor))]
